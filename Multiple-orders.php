...
if (isset($_POST['submit_order'])) {
    ...
    if (!empty($_SESSION['cart']) && $order_type === "Take-out") { 
        ...
        if($discount > 0){
            echo "<p style='color:green;'>✅ Take-out Order placed! You got {$discount}% member discount applied. Total: ₱".number_format($total_order,2)."</p>";
        } else {
            echo "<p style='color:green;'>✅ Take-out Order successfully placed. Total: ₱".number_format($total_order,2)."</p>";
        }
    }
}
